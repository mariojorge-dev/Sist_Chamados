...
if (!empty($_GET['email'])) {
    ...
    $stmt = $conexao->prepare("SELECT * FROM chamados.chamados WHERE email = ?");
...
<body>
        ...
        <div class="form">
            <form action="solicitacao.php" method="POST">
                ...
                <div class="input-celular">
                    ...
                    <input placeholder="Número de telefone/celular do responsável" name="telefone" type="tel" name=""
                        id="telefone" value="<?php echo $telefone; ?>">
                </div>
    ...
    <fieldset>
        ...
        <textarea name="desc-problem" id="desc-problem" placeholder="Digite o problema da forma mais detalhada possível"><?php echo $descproblem; ?></textarea>
    </fieldset>
</div>
...
<div class="input-problema">
    ...
    <select name="problema" id="problema">
        ...
        <option value="internet" <?php if ($problema == 'internet') echo 'selected'; ?>>INTERNET</option>
        <option value="impressao" <?php if ($problema == 'impressao') echo 'selected'; ?>>IMPRESSÃO</option>
        <option value="sistema" <?php if ($problema == 'sistema') echo 'selected'; ?>>SISTEMA</option>
        <option value="aplicativo" <?php if ($problema == 'aplicativo') echo 'selected'; ?>>APLICATIVO</option>
        <option value="acesso-predial" <?php if ($problema == 'acesso-predial') echo 'selected'; ?>>ACESSO PREDIAL</option>
        <option value="pasta-arquivos-compartilhados" <?php if ($problema == 'pasta-arquivos-compartilhados') echo 'selected'; ?>>PASTA/ARQUIVOS COMPARTILHADOS</option>
        <option value="celular" <?php if ($problema == 'celular') echo 'selected'; ?>>CELULAR</option>
        <option value="rede" <?php if ($problema == 'rede') echo 'selected'; ?>>REDE</option>
        <option value="outros" <?php if ($problema == 'outros') echo 'selected'; ?>>OUTROS</option>
    </select>
</div>
        ...
        <div class="input-desc-problem">
            <fieldset>
                ...
                <textarea name="desc-problem" id="desc-problem"
                    placeholder="Digite o problema da forma mais detalhada possivel"
                    value="<?php echo $descproblem; ?>"></textarea>
            </fieldset>
        </div>
        <button class="btn"><a href="./index.php">Voltar</a></button><button class="btn" name="submit" type="submit"
